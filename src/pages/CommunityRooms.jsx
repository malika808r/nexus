        ...
        {ROOMS.map((room, idx) => (
          ...
          >
             ...
             <div className="mt-6 flex items-center gap-2 relative z-10">
                ...
                <span className="text-[11px] font-black uppercase tracking-widest opacity-40">+{room.count - 3} others</span>
             </div>
          </motion.div>
        ))}

        {/* Create Custom Room Placeholder */}
        <div className="card p-8 border-dashed flex flex-col items-center justify-center text-center opacity-50 hover:opacity-100 transition-opacity cursor-pointer">
           <div className="w-12 h-12 rounded-full border-2 border-dashed flex items-center justify-center mb-4">
              <Plus size={24} />
           </div>
           <p className="font-bold text-sm">Создать свою комнату</p>
        </div>
      </div>
    </div>
  );
